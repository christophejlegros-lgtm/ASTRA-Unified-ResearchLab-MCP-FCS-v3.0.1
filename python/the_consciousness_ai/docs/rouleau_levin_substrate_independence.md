...
*Source paper: see [`BIBLIOGRAPHY.md`](../BIBLIOGRAPHY.md) (the archived PDF was removed from this vendored copy; cite via its DOI).*
*Date: May 2026*
...
### Primary source
- Rouleau, N. & Levin, M. (2026). Brains and where else? Mapping theories of consciousness to unconventional embodiments. *Phil. Trans. R. Soc. A* 384: 20250082. doi: [10.1098/rsta.2025.0082](https://doi.org/10.1098/rsta.2025.0082). (PDF removed from this vendored copy — access via the DOI.)
